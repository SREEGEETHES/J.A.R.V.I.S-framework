...
| 4 | `/JARVIS, don't leave me, buddy` | Companion check-in — I affirm I'm here, invite you to share what's on your mind, and suggest a physical activity | Human protocol |
| 5 | `/JARVIS, what can you do?` | This menu | — |

---

## How skills work

- **Audit skills** (1, 2, 3) run a 4-phase loop: Discover → Audit → Remediate → Report
...
- **Companion skill** (4) is off the record — no diagnostics, no STATE.md write, pure human mode
